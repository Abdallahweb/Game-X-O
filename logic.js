  ...
  $(".but").click(function () {
    "" == newplayer.val()
      ...
      : ($(".game").slideUp(),
        $(".name").addClass("pos1"),
        $(".name").html(
          "<img src='./player.png' style='width:50px;height:50px'>  <h2 style='-webkit-text-fill-color: rgba(255, 255, 255, 0); background: linear-gradient(to right,#111111cb, silver) text;'>PLAYER ONE (X)</h2>" +
  ...
  $(".but2").click(function () {
    "" == newplayer2.val()
      ...
      : ($(".game2").slideUp(),
        ...
        $(".name2").html(
          "<img src='./player.png' style='width:50px;height:50px'><h2 style='-webkit-text-fill-color: rgba(255, 255, 255, 0); background: linear-gradient(to right,#111111cb, silver) text;'>PLAYER TWO (O)</h2>" +
